...
class BPR(object):
    ...
    def init(self, data):
        ...
        self.user_factors = np.random.random_sample((self.num_users, self.dim))
        self.item_factors = np.random.random_sample((self.num_items, self.dim))
    ...
    def update_factors(self, u, i, j, update_u=True, update_i=True):
        ...
        if update_u:
            d = (self.item_factors[i, :] - self.item_factors[j, :]) * z - self.user_regularization * self.user_factors[
                                                                                                     u, :]
